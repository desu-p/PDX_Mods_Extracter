...
### how to use (◕‿◕)
1. put `pdx_mods_extractor.ps1` in your mod download folder (where the .zip files are).
2. right-click and **run with powershell**.
3. check your `Documents/Paradox Interactive/[Game]/mod` folder.
4. please be kind to me! (´｡• ᵕ •｡`)

---
*made with love and a bit of sadness by desu-p* (づ｡◕‿‿◕｡)づ
